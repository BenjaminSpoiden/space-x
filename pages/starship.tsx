...
function Starship() {
    ...
    const { data } = useRocketQuery({ variables: {rocketName: "starship"} })
        ...
        <Layout title="Starship">
            <main className="max-w-8xl mx-auto" >
                <div className="flex flex-col justify-center items-center max-w-8xl mx-auto min-h-screen py-6 sm:px-6 lg:px-8">
                    <RocketLayout rocket={data?.rocket} image="/starship.png" />
...
export default withApollo(Starship, { getDataFromTree })